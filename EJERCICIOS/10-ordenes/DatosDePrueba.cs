...
public class DatosdePrueba
{
    ...
    public void CrearOrden()
    {
        ...
        Console.WriteLine("");
        Console.WriteLine("El Subtotal de la orden es de: " + nuevaOrden.Subtotal);   //imprimir subtotal
        Console.WriteLine("El Impuesto de la orden es de: " + nuevaOrden.Impuesto);   //imprimir impuesto
    ...
    public void ListarOrdenes()
    {
        ...
        Console.WriteLine("================");
        Console.WriteLine("");  
        Console.WriteLine("Codigo | Fecha |         Subtotal | Impuesto | Total |");   //agregamos el impuesto y total a nuestra orden
