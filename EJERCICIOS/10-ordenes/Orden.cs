...
public class Orden
{
    ...
    public double Subtotal { get; set; }   //agregando propiedad subtotal
    public double Impuesto { get; set; }   //agregando propiedad impuesto
    ...
    public void AgregarProducto(Producto producto)
    {
        ...
        Impuesto += Subtotal * 0.15;    //agregando operacion subtotal
        Total += Subtotal + Impuesto;   //agregando operacion impuesto
