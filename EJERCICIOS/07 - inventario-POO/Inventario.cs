...
{
    public List<Producto> ListadeProductos { get; set; } //arreglo para lista (<Producto> dentro de diamantes)
    public Inventario()
    {
    ...
    public void listarProductos() {
        ...
        foreach (var producto in ListadeProductos) //hace un recorrido por los productos
        {
    ...
    public void salidaDeInventario() { // 2) salida de inventario
        string codigo = "";
        string cantidad = "";
    ...
    public void ajusteNegativoDeInventario() { // 3) ajuste negativo al inventario 
        string codigo = "";
        string cantidad = "";
    ...
    public void ajustePositivoDeInventario() { // 4) ajuste positivo al inventario
        string codigo = "";
        string cantidad = "";
